class TS_Lightning_Horizon extends TS_Projectile;
...
DefaultProperties
{
	...
	ProjFlightTemplate=ParticleSystem'UPK_Props.Lightning_Beam_Horizontal';
    ProjExplosionTemplate=ParticleSystem'UPK_Props.Lightning_Explosion';
	//SpawnSound=SoundCue'';
	ImpactSound=SoundCue'UPK_Sounds.Thunder_Cue';
