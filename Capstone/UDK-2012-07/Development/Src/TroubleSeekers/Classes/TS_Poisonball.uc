class TS_Poisonball extends TS_Projectile;
...
DefaultProperties
{
	...
	ProjFlightTemplate=ParticleSystem'UPK_Props.Poison_Cloud_Moving';
    ProjExplosionTemplate=ParticleSystem'UPK_Props.Poison_Explosion';
	SpawnSound=SoundCue'UPK_Sounds.Poisonball_Cue';
	ImpactSound=SoundCue'UPK_Sounds.Sizzle_Cue';
