class MyBoss extends TS_Pawn placeable;
...
simulated event PostBeginPlay()
{
	...
	{
		Owner.WorldInfo.Game.Broadcast(Owner, "Enemy Spawned");
...
simulated function bool Died(Controller Killer, class<DamageType> damageType, Vector HitLocation)
{
	...
	MyPawn(Killer.Pawn).TSEventManager.AddKill(class'MyBoss');
...
defaultproperties
{
  ...
  Begin Object Class=SkeletalMeshComponent Name=NPCMesh0
    ...
    PhysicsAsset=PhysicsAsset'UPK_Characters.TS_Human'
  ...
  NPCController=class'TroubleSeekers.MyEnemyController'
}